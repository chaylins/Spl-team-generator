-- Table: public.spl_games_archive

-- DROP TABLE IF EXISTS public.spl_games_archive;

CREATE TABLE IF NOT EXISTS public.spl_games_archive
(
    ...
    CONSTRAINT spl_games_pkey_1 PRIMARY KEY (battle_queue_id_1, battle_queue_id_2)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS public.spl_games_archive
    OWNER to postgres;